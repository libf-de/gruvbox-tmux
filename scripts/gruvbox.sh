...
main()
{
  ...
  show_fahrenheit=$(get_tmux_option "@gruvbox-show-fahrenheit" false)
  show_location=$(get_tmux_option "@gruvbox-show-location" false)
  show_powerline=$(get_tmux_option "@gruvbox-show-powerline" true)
  show_flags=$(get_tmux_option "@gruvbox-show-flags" false)
  show_left_icon=$(get_tmux_option "@gruvbox-show-left-icon" window)
  ...
  show_timezone=$(get_tmux_option "@gruvbox-show-timezone" false)
